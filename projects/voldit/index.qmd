...
<div class="showcase-heading"><h2 id="examples-title">Synthetic lung CT</h2></div>
<figure class="cine-figure">
<div class="cine-stage">
<div class="volume-plane-labels" aria-hidden="true"><span>Axial</span><span>Coronal</span><span>Sagittal</span></div>
<video id="voldit-cine" controls loop playsinline preload="none" poster="assets/lung-example-1.jpg" aria-label="Synthetic VolDiT example 1, scrolling through axial, coronal and sagittal views"><source src="assets/lung-example-1.mp4" type="video/mp4">Your browser cannot play this video. <a href="assets/lung-example-1.mp4">Open the synthetic CT example.</a></video>
</div>
<div class="cine-controls" role="group" aria-label="Choose a synthetic CT video">
<span>Explore samples</span><button type="button" data-cine="1" aria-pressed="true" aria-controls="voldit-cine">Example 1</button><button type="button" data-cine="2" aria-pressed="false" aria-controls="voldit-cine">Example 2</button>
</div>
<noscript><p><a href="assets/lung-example-2.mp4">Watch example 2.</a></p></noscript>
</figure>
...
<p class="project-reading">Rotate a synthetic CT in 3D, cut into the volume, or inspect it slice by slice. Switch between lung, soft-tissue, and bone windows to explore different structures.</p>
<section id="voldit-viewer" class="volume-viewer" data-manifest="assets/volumes.json" aria-label="Interactive 3D CT viewer">
...
<p class="project-source">Synthetic examples from the LUNA16 experiments, reduced from 512 × 512 × 256 to 256 × 256 × 128 voxels for the browser. The full field of view is retained. Intensities are clipped to −1200…300 HU, as in the original exports. Powered by <a href="https://niivue.com/">NiiVue</a>.</p>
</div></section>
...
<script type="module" src="viewer.js?v=2"></script>
```
